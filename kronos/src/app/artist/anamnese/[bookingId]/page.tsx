                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <span className="text-[10px] font-mono text-primary uppercase tracking-widest font-black">Prontuário Autenticado</span>
                            </div>
                            <h1 className="text-3xl font-orbitron font-black text-white uppercase italic tracking-tighter">
                                Ficha de <span className="text-primary">Anamnese</span>
                            </h1>
                        </div>
                    </div>
...
function DataField({ label, value, highlight = false }: { label: string, value: string | null | undefined, highlight?: boolean }) {
    return (
        <div className={`p-4 rounded-2xl border transition-all ${highlight ? 'bg-white/5 border-primary/30' : 'bg-zinc-950/40 border-white/5'}`}>
            <p className="text-[10px] text-gray-500 font-mono uppercase tracking-widest mb-2">{label}</p>
            <p className={`text-sm ${highlight ? 'text-primary font-bold' : 'text-zinc-300'}`}>
