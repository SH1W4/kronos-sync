            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/5 pb-8">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        <div className="w-10 h-10 bg-primary/10 border border-primary/20 rounded-xl flex items-center justify-center shadow-[0_0_15px_var(--primary-glow)]">
                            <Terminal size={20} className="text-primary" />
                        </div>
                        <span className="text-[10px] font-mono text-primary uppercase tracking-[0.4em] font-bold">Base de Conhecimento</span>
                    </div>
                ...
                <div className="relative group">
                    ...
                    <input
                        ...
                        className="bg-white/5 border border-white/10 rounded-xl py-2.5 pl-10 pr-4 text-[10px] font-mono text-gray-300 focus:outline-none focus:border-primary/40 focus:bg-white/10 transition-all w-full md:w-64"
                    />
                </div>
            </div>
                    ...
                    {selectedDoc ? (
                        <div className="p-8 md:p-12 overflow-y-auto max-h-[80vh] custom-scrollbar">
                            ...
                            {selectedDoc.metadata?.priority && (
                                <div className="inline-flex items-center gap-2 px-2 py-1 bg-primary/10 border border-primary/20 rounded md mb-6">
                                    <span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse shadow-[0_0_5px_var(--primary-glow)]"></span>
                            ...
                            <article className="prose prose-invert prose-primary max-w-none">
                                <ReactMarkdown
                                    components={{
                                        ...
                                        h2: ({ node, ...props }) => <h2 className="text-xl font-orbitron font-bold text-primary mt-10 mb-4 flex items-center gap-2" {...props} />,
                                        ...
                                        code: ({ node, ...props }) => <code className="bg-primary/10 text-primary px-1.5 py-0.5 rounded font-mono text-xs border border-primary/20" {...props} />,
                                        blockquote: ({ node, ...props }) => (
                                            <blockquote className="border-l-4 border-primary/50 bg-primary/5 p-4 rounded-r-xl italic my-6 text-gray-300 text-sm" {...props} />
                                        ),
